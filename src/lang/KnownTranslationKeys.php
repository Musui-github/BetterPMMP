...
final class KnownTranslationKeys{
	...
	public const COMMANDS_SCOREBOARD_USAGE = "commands.scoreboard.usage";
	...
	public const POCKETMINE_COMMAND_SCOREBOARD_DESCRIPTION = "pocketmine.command.scoreboard.description";
